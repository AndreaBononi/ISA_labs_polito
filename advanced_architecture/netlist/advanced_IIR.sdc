...
# Created by write_sdc on Thu Oct 28 11:58:38 2021
...
create_clock [get_ports clk]  -name MYCLK  -period 12  -waveform {0 6}
...
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[10]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[9]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[8]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[7]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[6]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[5]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[4]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[3]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[2]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[1]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1[0]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[10]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[9]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[8]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[7]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[6]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[5]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[4]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[3]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[2]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[1]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {a1quad[0]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {b1[10]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {b1[9]}]
...
set_input_delay -clock MYCLK  -max 0.5  [get_ports {b0[10]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {b0[9]}]
...
set_input_delay -clock MYCLK  -max 0.5  [get_ports {din[10]}]
set_input_delay -clock MYCLK  -max 0.5  [get_ports {din[9]}]
...
set_output_delay -clock MYCLK  -max 0.5  [get_ports {dout[10]}]
set_output_delay -clock MYCLK  -max 0.5  [get_ports {dout[9]}]
